...
>
	...
	<?php endif; ?>
		<div class="container-fluid">
			<div class="row">
				<div class="col s3">
					<input type="text" name="<?php echo $name; ?>" class="select-image hasTooltip field-media-input" id="<?php echo $id; ?>" value="<?php echo htmlspecialchars($value, ENT_COMPAT, 'UTF-8'); ?>" readonly="readonly"<?php echo $attr; ?>/>
				</div>
				<?php if ($disabled != true) : ?>
					<div class="col s6">
						<div class="btn-group input-group-append">
							<button type="button" class="btn button-select ml-10"><?php echo JText::_("JLIB_FORM_BUTTON_SELECT"); ?></button>
							<button
								type="button"
								class="btn hasTooltip button-clear ml-10 white"
